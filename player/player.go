...
func (p Player) Print() {
	Tile.PrintTile(p.stocks[0]) // black   /// was LEADER
	Tile.PrintTile(p.stocks[1]) // blue
	Tile.PrintTile(p.stocks[2]) // green
	Tile.PrintTile(p.stocks[3]) // red
	Tile.PrintTile(p.stocks[4]) // red  //
	Tile.PrintTile(p.stocks[5]) // red  //
	Tile.PrintTile(p.stocks[6]) // red  //
